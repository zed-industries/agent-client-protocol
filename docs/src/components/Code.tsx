  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-teal-400/10 ring-1 ring-teal-400/20 ring-inset'
...
function CodePanelHeader({ tag, label }: { tag?: string; label?: string }) {
  ...
  return (
    <div className="flex h-9 items-center gap-2 border-y border-t-transparent border-b-white/7.5 bg-neutral-900 px-4 dark:border-b-white/5 dark:bg-white/1">
      {tag && (
...
function CodeGroupHeader({
  ...
  return (
    <div className="flex min-h-[calc(--spacing(12)+1px)] flex-wrap items-start gap-x-4 border-b border-neutral-800 bg-neutral-900 px-4 dark:border-neutral-800">
      {title && (
...
export function CodeGroup({
  ...
  let containerClassName =
    'my-6 overflow-hidden rounded-xl bg-neutral-950 shadow-md dark:ring-1 dark:ring-white/10'
  let header = (
