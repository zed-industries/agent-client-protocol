...
```
High level diagram
some text about the architecture
over MCP, agent runs an MCP server + client 
...
Protocol Flow 
  ...
  LLM turn (acp.rs)
    ...
    - Plans
- Client Tools 
  Enrich agent with more capabilities like:
    - Request tool permission
    - Access Editor file system
Libraries
  - TypeScript
  - Rust 
  These are just auto-generated from schema.json, you can use whatever language 
- Specification
  Auto-generated from schema.json
  
- FAQ

- Agent tools (what zed calls into) - acp.rs
