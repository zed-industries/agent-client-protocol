...
// NewContentBlockText constructs a ContentBlock using the 'text' variant.
...
// NewContentBlockImage constructs a ContentBlock using the 'image' variant.
func NewContentBlockImage(data string, mimeType string) ContentBlock {
	return ContentBlock{Image: &ContentBlockImage{
		Data:     data,
		MimeType: mimeType,
		Type:     "image",
...
// NewContentBlockAudio constructs a ContentBlock using the 'audio' variant.
func NewContentBlockAudio(data string, mimeType string) ContentBlock {
	return ContentBlock{Audio: &ContentBlockAudio{
		Data:     data,
		MimeType: mimeType,
		Type:     "audio",
...
// NewContentBlockResourceLink constructs a ContentBlock using the 'resource_link' variant.
func NewContentBlockResourceLink(name string, uri string) ContentBlock {
	return ContentBlock{ResourceLink: &ContentBlockResourceLink{
		Name: name,
		Type: "resource_link",
		Uri:  uri,
...
// NewContentBlockResource constructs a ContentBlock using the 'resource' variant.
func NewContentBlockResource(resource EmbeddedResourceResource) ContentBlock {
	return ContentBlock{Resource: &ContentBlockResource{
		Resource: resource,
		Type:     "resource",
	}}
...
// NewSessionUpdateUserMessageChunk constructs a SessionUpdate using the 'user_message_chunk' variant.
func NewSessionUpdateUserMessageChunk(content ContentBlock) SessionUpdate {
	return SessionUpdate{UserMessageChunk: &SessionUpdateUserMessageChunk{
		Content:       content,
		SessionUpdate: "user_message_chunk",
	}}
}

// NewSessionUpdateAgentMessageChunk constructs a SessionUpdate using the 'agent_message_chunk' variant.
func NewSessionUpdateAgentMessageChunk(content ContentBlock) SessionUpdate {
	return SessionUpdate{AgentMessageChunk: &SessionUpdateAgentMessageChunk{
		Content:       content,
		SessionUpdate: "agent_message_chunk",
	}}
}

// NewSessionUpdateAgentThoughtChunk constructs a SessionUpdate using the 'agent_thought_chunk' variant.
func NewSessionUpdateAgentThoughtChunk(content ContentBlock) SessionUpdate {
	return SessionUpdate{AgentThoughtChunk: &SessionUpdateAgentThoughtChunk{
		Content:       content,
		SessionUpdate: "agent_thought_chunk",
	}}
}

// NewSessionUpdateToolCall constructs a SessionUpdate using the 'tool_call' variant.
func NewSessionUpdateToolCall(toolCallId ToolCallId, title string) SessionUpdate {
	return SessionUpdate{ToolCall: &SessionUpdateToolCall{
...
// NewSessionUpdateToolCallUpdate constructs a SessionUpdate using the 'tool_call_update' variant.
func NewSessionUpdateToolCallUpdate(toolCallId ToolCallId) SessionUpdate {
	return SessionUpdate{ToolCallUpdate: &SessionUpdateToolCallUpdate{
		SessionUpdate: "tool_call_update",
		ToolCallId:    toolCallId,
	}}
}

// NewSessionUpdatePlan constructs a SessionUpdate using the 'plan' variant.
func NewSessionUpdatePlan(entries []PlanEntry) SessionUpdate {
	return SessionUpdate{Plan: &SessionUpdatePlan{
		Entries:       entries,
		SessionUpdate: "plan",
	}}
}

// NewToolCallContentContent constructs a ToolCallContent using the 'content' variant.
...
// NewToolCallContentDiff constructs a ToolCallContent using the 'diff' variant.
func NewToolCallContentDiff(path string, newText string) ToolCallContent {
	return ToolCallContent{Diff: &ToolCallContentDiff{
		NewText: newText,
		Path:    path,
		Type:    "diff",
...
// NewToolCallContentTerminal constructs a ToolCallContent using the 'terminal' variant.
...
func StartReadToolCall(id ToolCallId, title string, path string, opts ...ToolCallStartOpt) SessionUpdate {
	base := []ToolCallStartOpt{WithStartKind(ToolKindRead), WithStartStatus(ToolCallStatusPending), WithStartLocations([]ToolCallLocation{ToolCallLocation{Path: path}}), WithStartRawInput(map[string]any{"path": path})}
...
func StartEditToolCall(id ToolCallId, title string, path string, content any, opts ...ToolCallStartOpt) SessionUpdate {
	base := []ToolCallStartOpt{WithStartKind(ToolKindEdit), WithStartStatus(ToolCallStatusPending), WithStartLocations([]ToolCallLocation{ToolCallLocation{Path: path}}), WithStartRawInput(map[string]any{
		"content": content,
		"path":    path,
	})}
	args := append(base, opts...)
